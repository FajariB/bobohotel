            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{route('admin.hotels.update', $hotel)}}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="address" id="address" cols="30" rows="5" class="border border-slate-300 rounded-xl w-full"> 
                            {{$hotel->address}}
                        </textarea>
                    ...
                    <div class="mt-4">
                        <x-input-label for="star_rating" :value="__('star level')" />
                        <x-text-input id="star_rating" class="block mt-1 w-full" type="number" name="star_rating" 
                        value="{{$hotel->star_rating}}" autofocus autocomplete="star_rating" />
